// <copyright file="PlayerCombatant.cs" company="Roberto Sobreviela">
...
namespace D5tools.Core.Combat
{
    ...
    public class PlayerCombatant
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerCombatant"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerCombatant"/> class from a <see cref="Creature"/>
        /// </summary>
        /// <param name="creature">A creature.</param>
        public PlayerCombatant(Creature creature)
        {
